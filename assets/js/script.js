...
$.getJSON("https://api-alquranid.herokuapp.com/surah/"+data, function(value){
    ...
    $.each(value.data, function(i, value){
        $('#body-detail-surah').append('<div class="mb-5"><h6 class="text-center fs-4 fw-bolder">'+ value.ar+'</h6><p class="mt-3 text-center">'+ value.nomor +'. '+ value.tr +'</p><p class="mt-3 text-center">'+ value.id +'</p></div>');
    });
